...
This Rainbow interpreter is written in Python, and accepts most popular image formats as input, although .BMP is recommended. To run a program, invoke python on Rainbow.py, with your program's path as the first argument.
